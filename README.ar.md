...
# XXD Panel 174｜تجمع ملصقات مرسومة بخطوط عفوية
...
وحدات مستقلة تشبه الملصقات العفوية تتجمع في المركز لتكوين موضوع واحد، لا شبكة منتظمة ولا نثراً عشوائياً.
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 174 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-174`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-174 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-174-prompt.en.md) أو [بالصينية](references/xxd-panel-174-prompt.zh-CN.md).
